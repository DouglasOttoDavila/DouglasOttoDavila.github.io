// Reused from js/relationship-graph/adapter.js; ES module adaptation.
import { RelationshipGraphConfig } from './config.js';


    const graphConfig = RelationshipGraphConfig;
    ...
    export const RelationshipGraphAdapter = {
