// Reused from js/relationship-graph/action-interpreter.js; ES module adaptation.
import { GraphTraversalUtils } from './traversal-utils.js';


    const traversalUtils = GraphTraversalUtils;
